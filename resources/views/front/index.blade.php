                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="most-popular-body mt-2">
                                <div class="most-popular-author d-flex justify-content-between">
                                    <div>
                                        Yazar: <a href="{{ route("front.authorArticles",["user" => $article->user->username])}}">{{ $article->user->name }}</a>
                                    </div>
    ...
    <section class="telegram d-flex align-items-center mt-5 p-4 rounded-2 text-white">
        ...
        <div class="telegram-body">
            ...
            <a href="{{ isset($settings) ? $settings->telegram_link : "javascript:void(0)" }}"
               class="btn btn-warning p-3 text-black"
               target="_blank"
            >Telegrama Katıl</a>
        </div>
            ...
            <div class="col-md-4 mt-4">
                ...
                <div class="most-popular-body mt-2">
                    <div class="most-popular-author d-flex justify-content-between">
                        ...
                        <div class="text-end">Kategori: <a href="{{ route("front.categoryArticles", ['category' => $article->category->slug]) }}">
                                {{ $article->category->name }}
                            </a>
                        </div>
                    </div>
