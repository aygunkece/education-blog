...
@section("content")
        ...
        <x-slot:body>
            ...
            >
                <x-slot:columns>
                    ...
                    <th scope="col">Feature_Status</th>
                                ...
                                <div class="d-flex">
                                    ...
                                    <a href="{{ route('categories.edit',['id'=>$category->id]) }}"
                                       class="btn btn-warning btn-sm">
                                        <i class="material-icons ms-0">edit</i></a>
    ...
    <form action="" method="POST" id="formStatusChange">
        ...
        $(document).ready(function () {
            ...
            $(".btnChangeStatus").click(function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $('#formStatusChange').attr("action", "{{ route('categories.changeStatus') }}");
            ...
            $(".btnChangeFeatureStatus").click(function () {
                ...
                Swal.fire({
                    ...
                    /* Read more about isConfirmed, isDenied below */
                    if (result.isConfirmed) {
                        $('#formStatusChange').attr("action", "{{ route('categories.changeFeatureStatus') }}");
                        $('#formStatusChange').submit();
                        Swal.fire('Saved!', '', 'success')
                    } else if (result.isDenied) {
                        Swal.fire({
            ...
            $(".btnDelete").click(function () {
                ...
                Swal.fire({
                    ...
                    /* Read more about isConfirmed, isDenied below */
                    if (result.isConfirmed) {
                        $('#formStatusChange').attr("action", "{{ route('categories.delete') }}");
                        $('#formStatusChange').submit();
                        Swal.fire('Saved!', '', 'success')
                    } else if (result.isDenied) {
                        Swal.fire({
